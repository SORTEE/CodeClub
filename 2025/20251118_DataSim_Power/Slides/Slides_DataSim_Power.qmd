...
Simulation made easy with SQuID sim [GitHub SQUiDsim](https://squidgroup.org/squidSim_vignette/)
...
Another avenue of effect size estimation in regard to sample size:
...
- Define modelling plans a priori 
- Set estimation criteria a priori 
...
- Simulate fixed effects & interaction
- Simulate individual values (BLUPS) & their correlation
