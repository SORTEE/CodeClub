...
-   **Pull Request**: Propose edits or new sections by forking the GitHub repository and submitting a `Pull Request`. For clarity and fast review, please describe the purpose of your change clearly in the PR description.
-   **Open an issue**: Spot a typo, confusing wording, or missing topic? Open an `issue` to discuss it before making changes, or to suggest new ideas and resources.
